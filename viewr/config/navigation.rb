SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :feeds, '<i class="icon-retweet"></i> Feeds', '#'
    primary.item :general_settings, '<i class="icon-cog"></i> General Settings', '#'
    primary.item :user_management, '<i class="icon-user"></i> User Management', '#', :if => Proc.new { current_user.is_superadmin }
